...
### Full-Stack Developer — Laravel, Next.js, NestJS & React Native
...
I have experience developing multi-tenant platforms, role-based systems, payment integrations, scheduled jobs, queues, reporting systems, third-party integrations and production deployment workflows.

---

## 🚀 Professional Highlights

- Contributed to a Jobber-inspired enterprise ERP and CRM platform containing more than 70 business modules.
- Built multi-tenant SaaS applications with subscriptions, role-based access and branch-level data management.
- Developed inventory, invoicing, POS, purchasing, reporting, payroll and scheduling systems.
- Integrated QuickBooks Online, Stripe, PayPal, Razorpay, Google Maps, Google Drive, Cloudflare R2 and n8n.
- Developed mobile applications using React Native CLI and Expo.
- Delivered more than 20 WordPress, WooCommerce and Shopify websites.
...
### Radon Hub — Enterprise ERP, CRM and Inventory Platform

**Laravel · PHP · MySQL · JavaScript · QuickBooks API · Google APIs · n8n**
...
### Full-Stack Developer — Designo Graphy

**Remote · November 2025 – Present**

- Contributing to an enterprise ERP, CRM and inventory SaaS platform for a Canadian client.
...
I am currently interested in remote opportunities involving:
